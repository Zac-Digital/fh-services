...
namespace FamilyHubs.Report.Data.Migrations
{
    ...
    [Migration("20240514104900_AddServiceDim")]
    partial class AddServiceDim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyHubs.Report.Data.Entities.ServiceDim", b =>
                {
                    b.Property<int>("ServiceKey")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ServiceKey"));
                    ...
                    b.Property<byte?>("ServiceStatusTypeId")
                        .HasColumnType("tinyint");

                    b.Property<string>("ServiceStatusTypeName")
                        .HasMaxLength(50)
                    ...
                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("ServiceKey"));

                    b.ToTable("ServiceDim");
                });
            ...
            modelBuilder.Entity("FamilyHubs.Report.Data.Entities.ServiceSearchFact", b =>
                {
                    ...
                    b.HasOne("FamilyHubs.Report.Data.Entities.ServiceDim", "ServiceDim")
                        .WithMany()
